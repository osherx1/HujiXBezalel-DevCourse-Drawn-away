...
public class characterMovement : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 50)][Tooltip("Maximum movement speed")] public float maxSpeed = 10f;
    ...
    public void OnMovement(InputAction.CallbackContext context)
    {
        ...
        SetDirectionalInput(context.ReadValue<float>());
    }

    public void SetDirectionalInput(float input)
    {
        directionX = Mathf.Clamp(input, -1f, 1f);
    }
